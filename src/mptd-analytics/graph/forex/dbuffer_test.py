...
from backend.finance.indicators import candle, moving_average
...
class CandleDataBuffer(DataBuffer):
    def __init__(self,
        ...
        self.granularity = 'S5'
        self.buffer = []
        self.cols = [['date_time', 'tick', 'open', 'high', 'low', 'close'], ['average', 'ma12']]
...
while True:
    time.sleep(5)
    # print(cdstick_buffer.call_generator())
    logger.info(cdstick_buffer.call_generator()[-1])
# =====================================================================================================================
# def set_global_tick():
